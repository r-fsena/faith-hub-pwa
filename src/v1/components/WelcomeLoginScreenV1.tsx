...
import { triggerHaptic } from '../../v2/utils/haptics';
import { ChevronRightIcon, SparklesIcon } from '../../v2/components/Icons';
...
export const WelcomeLoginScreenV1: React.FC<WelcomeLoginScreenProps> = ({
  onLoginSuccess,
  onContinueAsGuest
}) => {
  ...
  return (
    <div style={{
      ...
      {/* Topo: Logo da Igreja & Botão Explorar */}
      <header style={{
        position: 'relative',
        zIndex: 10,
